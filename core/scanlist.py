...
class ManualSetItem(QtWidgets.QFrame):
    def __init__(self, channel_name, value, main_window=None):
        ...
        channel_title = QtWidgets.QLabel("Channel:")
        channel_title.setMinimumWidth(55)
        ...
        channel_row.addWidget(channel_title, 0)
        ...
        value_row.addWidget(value_title, 0)
        value_row.addWidget(self.value_edit, 0)
