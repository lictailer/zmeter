...
It is registered under driver ID `ni6423` with one optional text `address`,
interpreted as the existing NI device name. The registration is startup-only. For first commissioning keep
