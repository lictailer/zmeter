# 
# This is an example that demonstrates how to read and display the control output states from a Four9 Core Controller.
#
...
def main() -> None:
    ...
    try:
        ...
        while True:
            ...
            for output in system.control_outputs:
                if not output.enabled:
                    line += '   '
                else:
                    line += ' {0} '.format('1' if output.state else '0')
