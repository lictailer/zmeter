...
class SR830(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self._append_log("SR830 UI ready. Click connect, then start graph to monitor.", level="INFO")
    ...
    def set_frequency(self, val: float | None = None):
        self.logic.stop()
        self.logic.setpoint_frequency = self.freq_doubleSpinBox.value() if val is None else val
    ...
    def set_amplitude(self, val: float | None = None):
        self.logic.stop()
        self.logic.setpoint_amplitude = self.ampl_doubleSpinBox.value() if val is None else val
    ...
    def set_time_constant(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_time_constant = self.time_constant_comboBox.currentIndex() if val is None else val
    ...
    def set_sensitivity(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_sensitivity = self.sensitivity_comboBox.currentIndex() if val is None else val
    ...
    def set_phase(self, val: float | None = None):
        self.logic.stop()
        self.logic.setpoint_phase = self.phase_doubleSpinBox.value() if val is None else val
    ...
    def set_ref_input(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_ref_input = self.ref_comboBox.currentIndex() if val is None else val
    ...
    def set_ext_trigger(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_ext_trigger = self.trig_comboBox.currentIndex() if val is None else val
    ...
    def set_sync_filter(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_sync_filter = self.sync_200hz_checkBox.isChecked() if val is None else bool(val)
    ...
    def update_sync_filter(self, info):
        ...
        self.sync_200hz_checkBox.setChecked(bool(info))
        self.sync_200hz_checkBox.blockSignals(False)

    def set_harmonic(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_harmonic = self.harmonics_spinBox.value() if val is None else val
    ...
    def set_input_config(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_input_config = self.input_config_comboBox.currentIndex() if val is None else val
    ...
    def set_input_shield(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_input_shield = self.input_shield_comboBox.currentIndex() if val is None else val
    ...
    def set_input_coupling(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_input_coupling = self.input_coupling_comboBox.currentIndex() if val is None else val
    ...
    def set_notch_filter(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_notch_filter = self.notch_filter_comboBox.currentIndex() if val is None else val
    ...
    def set_reserve(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_reserve = self.reserve_comboBox.currentIndex() if val is None else val
    ...
    def set_filter_slope(self, val: int | None = None):
        self.logic.stop()
        self.logic.setpoint_filter_slope = self.filter_slope_comboBox.currentIndex() if val is None else val
    ...
    def update_unlocked(self, info):
        ...
        self.unlocked_radioButton.setChecked(bool(info))
    ...
    def update_input_overload(self, info):
        ...
        self.input_ovld_radioButton.setChecked(bool(info))
    ...
    def update_time_constant_overload(self, info):
        ...
        self.tc_ovld_radioButton.setChecked(bool(info))
    ...
    def update_output_overload(self, info):
        ...
        self.sens_ovld_radioButton.setChecked(bool(info))
